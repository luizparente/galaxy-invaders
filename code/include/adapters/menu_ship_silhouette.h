#ifndef GALAXY_INVADERS_ADAPTERS_MENU_SHIP_SILHOUETTE_H
#define GALAXY_INVADERS_ADAPTERS_MENU_SHIP_SILHOUETTE_H

#include <stdint.h>

/* Solid black silhouette for the decorative B-20 hero ship shown
...
#define MENU_SHIP_SILHOUETTE_W 800
#define MENU_SHIP_SILHOUETTE_H 656

extern const uint32_t kMenuShipSilhouettePixels[MENU_SHIP_SILHOUETTE_W * MENU_SHIP_SILHOUETTE_H];
